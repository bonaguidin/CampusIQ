"""Execute the syllabus grade profiles migration against an isolated PostgreSQL 17 cluster."""
...
ASSERTIONS = ROOT / "tests/sql/syllabus_grade_profiles_assertions.sql"
...
def test_syllabus_grade_profiles_migration(tmp_path):
