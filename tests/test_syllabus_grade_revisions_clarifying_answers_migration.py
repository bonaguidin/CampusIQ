"""Execute the clarifying_answers migration against an isolated PostgreSQL 17 cluster.
...
column's default, constraints, and its deliberate exclusion from the
extraction-immutability trigger.
"""
...
CLARIFYING_MIGRATION = ROOT / "supabase/migrations/20260828120000_syllabus_grade_revisions_clarifying_answers.sql"
ASSERTIONS = ROOT / "tests/sql/syllabus_grade_revisions_clarifying_answers_assertions.sql"
...
def test_syllabus_grade_revisions_clarifying_answers_migration(tmp_path):
    ...
    try:
        ...
        for sql in (BASE, MIGRATION, CLARIFYING_MIGRATION):
