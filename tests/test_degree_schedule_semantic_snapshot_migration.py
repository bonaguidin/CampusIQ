"""Execute the semantic-fingerprint bridge in isolated PostgreSQL."""
...
FILES = (
    ...
    MIGRATIONS / "20260824140000_degree_schedule_semantic_snapshot.sql",
    SQL / "degree_schedule_semantic_snapshot_assertions.sql",
)
...
def test_degree_schedule_semantic_snapshot_bridge_and_permissions(tmp_path):
