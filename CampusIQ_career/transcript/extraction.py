...
CampusIQ_career.resume.extraction rather than copied, so a fix to either one
...
temporary. The cleaner shape is a shared CampusIQ_career/extraction/ package
...
# CampusIQ_career/extraction/ package is where they should end up public.
from CampusIQ_career.resume.extraction import (
    DOCX_CONTENT_TYPES,
...
def extract_transcript_text(
    ...
    (CampusIQ_career/resume/parser.py, build_messages). Copying that behaviour
