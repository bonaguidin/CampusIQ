...
- [ ] C2R.5 final live validation: confirm deterministic seed coverage, direct target classifications, ranking quality, efficiency, and safety against the configured provider.
