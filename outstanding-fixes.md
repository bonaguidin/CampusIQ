...
- [ ] C2R.4 final live validation: confirm cross-search pool selection, target classifications, multiple eligible options, efficiency, and safety against the configured provider.
